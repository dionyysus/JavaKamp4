...
public class CALExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CALDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CALStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CALDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CALDateTimeConverter dateTimeConverter = new CALStandardDateTimeConverter();

    public CALExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CALExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CALMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CALHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CALExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CALHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
