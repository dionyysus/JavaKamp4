...
public class CALKPSPublicSoap
{
    ...
    public CALKPSPublicSoap(){}

    public CALKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CALKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CALExtendedSoapSerializationEnvelope envelope= new CALExtendedSoapSerializationEnvelope(CALExtendedSoapSerializationEnvelope.VER11);
